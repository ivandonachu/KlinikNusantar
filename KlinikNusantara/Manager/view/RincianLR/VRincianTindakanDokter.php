...
//sql data konten
    ...
    $nama_tindakan = $_GET['nama_tindakan'];
...
if ($tanggal_awal == $tanggal_akhir) {
    ...
    $table = mysqli_query($koneksi, "SELECT *  FROM antrian a INNER JOIN perawatan b ON a.no_antrian=b.no_antrian 
                                                            ...
                                                            INNER JOIN pasien f ON f.id_pasien =a.id_pasien
                                                            WHERE a.tanggal = '$tanggal_awal' AND e.nama_karyawan = '$nama_dokter' AND d.nama_tindakan = '$nama_tindakan' ");
    ...
    $table = mysqli_query($koneksi, "SELECT  * FROM antrian a INNER JOIN perawatan b ON a.no_antrian=b.no_antrian 
                                                            ...
                                                            INNER JOIN karyawan e ON b.id_dokter=e.id_karyawan 
                                                            INNER JOIN pasien f ON f.id_pasien =a.id_pasien
                                                            WHERE a.tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND e.nama_karyawan = '$nama_dokter' AND d.nama_tindakan = '$nama_tindakan'");
...
<head>
    ...
    <title>Rincian Tindakan <?php echo"$nama_tindakan" ?> Dokter <?php echo"$nama_dokter" ?></title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#601848;">
                    ...
                    <?php echo "<a href='VRLayananTindakan?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px; font-size: clamp(2px, 3vw, 22px);'>Rincian Tindakan $nama_tindakan Dokter $nama_dokter</h5></a>"; ?>
                ...
                <div align="left">
                <?php echo "<a href='VRincianDokter?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir&nama_dokter=$nama_dokter'><button type='button' class='btn btn-primary'>Kembali</button></a>"; ?>
                </div>
                    ...
                    <h6 align="Center">Rincian Layanan Tindakan <?php echo " $nama_tindakan" ; ?> yang dilakukan<?php echo " $nama_dokter" ; ?></h6>
                                <table id="example" class="table-sm table-striped table-bordered dt-responsive nowrap" style="width:100%; ">
                                <thead align = 'center'>
                                    <tr>
                                    <th  style='font-size: 12px'>No</th>
                                    <th  style='font-size: 12px'>Tanggal Perawatan</th>
                                    <th  style='font-size: 12px'>No Perawatan</th>
                                    <th  style='font-size: 12px'>Nama Pasien</th>
                                    <th  style='font-size: 12px'>Tindakan 1</th>
                                    <th  style='font-size: 12px'>QTY Tindakan 1</th>
                                    <th  style='font-size: 12px'>Tindakan 2</th>
                                    <th  style='font-size: 12px'>QTY Tindakan 2</th>
                                    <th  style='font-size: 12px'>Tindakan 3</th>
                                ...
                                <tbody>
                                    ...
                                    $no_perawatan =$data['nama_karyawan'];
                                    ...
                                    <td style='font-size: clamp(12px, 1vw, 15px);' align = 'center'>$tanggal</td>
                                    <td style='font-size: clamp(12px, 1vw, 15px);' align = 'center'>$no_perawatan</td>
                                    <td style='font-size: clamp(12px, 1vw, 15px);' align = 'center'>$nama_pasien</td>
                                    <td style='font-size: clamp(12px, 1vw, 15px);' align = 'center'>$tindakan_1</td>
                                    <td style='font-size: clamp(12px, 1vw, 15px);' align = 'center'>$qty_tindakan_1</td>
                                    <td style='font-size: clamp(12px, 1vw, 15px);' align = 'center'>$tindakan_2</td>
                                    <td style='font-size: clamp(12px, 1vw, 15px);' align = 'center'>$qty_tindakan_2</td>
                                    <td style='font-size: clamp(12px, 1vw, 15px);' align = 'center'>$tindakan_3</td>
