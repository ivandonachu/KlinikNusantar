...
if(isset($_GET['kode_obat'])){
    ...
    if ($tanggal_awal == $tanggal_akhir) {
        $table = mysqli_query($koneksi, "SELECT * FROM riwayat_obat a INNER JOIN obat b ON b.kode_obat=a.kode_obat 
        ...
        //pembelian obat
        $sql_pembelian_obat = mysqli_query($koneksi, "SELECT SUM(jumlah) AS pembelian_obat FROM riwayat_obat WHERE tanggal = '$tanggal_awal' AND kode_obat = '$kode_obat' ");
        ...
        //pembelian obat
        $sql_pembelian_obat = mysqli_query($koneksi, "SELECT SUM(jumlah) AS pembelian_obat FROM riwayat_obat WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND kode_obat = '$kode_obat' ");
...
<head>
    ...
    <title>Rincian Pembelian Obat</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#601848;">
                    ...
                    <?php echo "<a href='VRPembelianObat?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px; font-size: clamp(2px, 3vw, 22px);'>Rincian Pembelian Obat</h5></a>"; ?>
                ...
                <?php echo "<a href='../VLabaRugi?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><button type='button' class='btn btn-primary'>Kembali</button></a>"; ?>
                    ...
                    <!-- Tabel -->
                    <h6 align="Center">Riwayat Restok / Pembelian Obat</h6>
                        ...
                        <table id="example" class="table-sm table-striped table-bordered  nowrap" style="width:auto" align='center'>
                            ...
                            <tbody>
                                ...
                                <?php while ($data = mysqli_fetch_array($table)) {
                                    ...
                                    ?>
                                    <tr > 
                                    <th colspan="8" style="font-size: clamp(12px, 1vw, 15px);" align = "center">Total</th>
                                    <th colspan="3" style="font-size: clamp(12px, 1vw, 15px);" bgcolor="#F0F8FF"   align = "center"><?= formatuang($pembelian_obat); ?></th>
                                   </tr>
                            </tbody>
                        </table>
                    </div>
                        ...
                        <tbody>
                            ...
                            "; ?>
                                ...
                                <?php echo "<td style='font-size: clamp(12px, 1vw, 15px);'>"; ?>
                                     <!-- Button search -->
                                    <?php echo " <a href='VRPembelianObat?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir&kode_obat=$kode_obat'><i class='fa-solid fa-magnifying-glass'></i></a>"; ?>
