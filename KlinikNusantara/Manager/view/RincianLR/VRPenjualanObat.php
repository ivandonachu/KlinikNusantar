...
if ($tanggal_awal == $tanggal_akhir) {
    ...
    $table = mysqli_query($koneksi, "SELECT harga_jual, nama_obat, SUM(jumlah) AS pendapatan_obat , SUM(qty) AS total_terjual_obat FROM antrian a INNER JOIN perawatan b ON a.no_antrian=b.no_antrian 
...
<head>
    ...
    <title>Rincian Penjualan Obat</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#601848;">
                    ...
                    <?php echo "<a href='VRPenjualanObat?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px; font-size: clamp(2px, 3vw, 22px);'>Rincian Penjualan Obat</h5></a>"; ?>
