...
if(isset($_GET['kode_alkes'])){
    ...
    if ($tanggal_awal == $tanggal_akhir) {
        $table = mysqli_query($koneksi, "SELECT * FROM riwayat_alkes a INNER JOIN alat_kesehatan b ON b.kode_alkes=a.kode_alkes INNER JOIN karyawan c ON c.id_karyawan=a.id_karyawan WHERE tanggal = '$tanggal_awal' AND a.kode_alkes = '$kode_alkes' ");
        $table2 = mysqli_query($koneksi, "SELECT * FROM alat_kesehatan");
    } else {
        $table = mysqli_query($koneksi, "SELECT * FROM riwayat_alkes a INNER JOIN alat_kesehatan b ON b.kode_alkes=a.kode_alkes INNER JOIN karyawan c ON c.id_karyawan=a.id_karyawan WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND a.kode_alkes = '$kode_alkes' ORDER BY a.tanggal");
        $table2 = mysqli_query($koneksi, "SELECT * FROM alat_kesehatan");
    }
}
else{
    if ($tanggal_awal == $tanggal_akhir) {
        $table = mysqli_query($koneksi, "SELECT * FROM riwayat_alkes a INNER JOIN alat_kesehatan b ON b.kode_alkes=a.kode_alkes INNER JOIN karyawan c ON c.id_karyawan=a.id_karyawan WHERE tanggal = '$tanggal_awal' ");
        $table2 = mysqli_query($koneksi, "SELECT * FROM alat_kesehatan");
    } else {
        $table = mysqli_query($koneksi, "SELECT * FROM riwayat_alkes a INNER JOIN alat_kesehatan b ON b.kode_alkes=a.kode_alkes INNER JOIN karyawan c ON c.id_karyawan=a.id_karyawan WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' ORDER BY a.tanggal");
        $table2 = mysqli_query($koneksi, "SELECT * FROM alat_kesehatan");
    }
}
...
<head>
    ...
    <title>Data Alat Kesehatan</title>
                ...
                <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" align='right'>
                            <!-- Button Update Stok -->
                            <button style="font-size: clamp(7px, 3vw, 15px); " type="button" class="btn btn-primary" data-toggle="modal" data-target="#input"> <i class="fas fa-plus-square mr-2"></i>Update Stok Alkes</button>

                            <!-- Button Input Data obat -->
                            <button style="font-size: clamp(7px, 3vw, 15px); margin-right: 10px;" type="button" class="btn btn-primary" data-toggle="modal" data-target="#inputobat"> <i class="fas fa-plus-square mr-2"></i>Input Data Alkes</button>
                        </div>
                    </div>
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title"> Form Input Data Alkes</h5>
                                ...
                                <div class="modal-body" align="left">
                                    <?php echo "<form action='../proses/PTambahAlkes?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label>Stok Awal Alat Kesehatan</label>
                    ...
                    <div class="modal fade bd-example-modal-lg" id="input" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title"> Form Update Stok Alkes</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                ...
                                <!-- Form Input Data -->
                                <div class="modal-body" align="left">
                                    <?php echo "<form action='../proses/PUpdateAlkes?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label>Nama Alat Kesehatan</label>
                                            <select id="tokens" class="selectpicker form-control" name="nama_alkes" multiple data-live-search="true">
                                                <?php
                                                include 'koneksi.php';
                                                $result = mysqli_query($koneksi, "SELECT nama_alkes FROM alat_kesehatan");
                                    ...
                                    "; ?>
                                        ...
                                        <div class="modal fade bd-example-modal-lg" id="formedit<?php echo $data['no_riwayat']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <!-- Form Edit Data -->
                                                    <div class="modal-body" align="left">
                                                        <form action="../proses/EUpdateAlkes" enctype="multipart/form-data" method="POST">
                                        ...
                                        <div class="modal fade" id="PopUpHapus<?php echo $data['no_riwayat']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title"> <b> Hapus Riwayat Alat Kesehatan </b> </h4>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="close">
                                                            <span aria-hidden="true"> &times; </span>
                                                        </button>
                                                    </div>
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="../proses/HUpdateAlkes" method="POST">
                                                            <input type="hidden" name="no_riwayat" value="<?php echo $no_riwayat; ?>">
                                                            <input type="hidden" name="tanggal1" value="<?php echo $tanggal_awal; ?>">
                                                            <input type="hidden" name="tanggal2" value="<?php echo $tanggal_akhir; ?>">
                                                            <div class="form-group">
                                                                <h6> Yakin Ingin Hapus Data Riwayat Alat Kesehatan? </h6>
                                                            </div>
                    ...
                    <table id="example1" class="table-sm table-striped table-bordered  nowrap" style="width:auto" align="center">
                        ...
                        <tbody>
                            ...
                            "; ?>
                                <?php echo "<td style='font-size: clamp(12px, 1vw, 15px);'>"; ?>
                                <button style=" font-size: clamp(7px, 1vw, 10px); color:black; " href="#" type="submit" class=" btn bg-warning mr-2 rounded" data-toggle="modal" data-target="#formedit<?php echo $data['kode_alkes']; ?>" data-toggle='tooltip' title='Edit Data Alat Kesehatan'>
                                    <i class="fas fa-edit"></i> Edit</button>
                                <!-- Form EDIT DATA -->

                                <div class="modal fade" id="formedit<?php echo $data['kode_alkes']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title"> Edit Data Alat Kesehatan </h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="close">
                                                    <span aria-hidden="true"> &times; </span>
                                                </button>
                                            </div>
                                            ...
                                            <!-- Form Edit Data -->
                                            <div class="modal-body">
                                                <form action="../proses/EDataAlkes" enctype="multipart/form-data" method="POST">
                                                    <input type="hidden" name="tanggal1" value="<?php echo $tanggal_awal; ?>">
                                                    <input type="hidden" name="tanggal2" value="<?php echo $tanggal_akhir; ?>">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <label>Kode Alat Kesehatan</label>
                                                            <input class="form-control form-control-sm" type="text" name="kode_alkes" value="<?= $kode_alkes; ?>" required="" disabled>
                                                            <input type="hidden" name="kode_alkes" value="<?= $kode_alkes ; ?>">
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label>Nama Alat Kesehatan</label>
                                                            <input class="form-control form-control-sm" type="text" name="nama_alkes" value="<?= $nama_alkes; ?>" required="">
                                                        </div>
                                                    </div>
                                                    <br>
                                                    <div class="row">
                                ...
                                <!-- Button Hapus -->
                                <button style=" font-size: clamp(7px, 1vw, 10px);color:black;" href="#" type="submit" class=" btn btn-danger" data-toggle="modal" data-target="#PopUpHapus<?php echo $data['kode_alkes']; ?>" data-toggle='tooltip' title='Hapus Data Alat Kesehatan'>
                                    <i class="fa-solid fa-trash"></i> Hapus</button>
                                <div class="modal fade" id="PopUpHapus<?php echo $data['kode_alkes']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title"> <b> Hapus Data Alat Kesehatan</b> </h4>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="close">
                                                    <span aria-hidden="true"> &times; </span>
                                                </button>
                                            </div>
                                            ...
                                            <div class="modal-body">
                                                <form action="../proses/HDataAlkes" method="POST">
                                                    <input type="hidden" name="kode_alkes" value="<?= $kode_alkes; ?>">
                                                    <input type="hidden" name="tanggal1" value="<?php echo $tanggal_awal; ?>">
                                                    <input type="hidden" name="tanggal2" value="<?php echo $tanggal_akhir; ?>">
                                                    <div class="form-group">
                                                        <h6> Yakin Ingin Hapus Data Alat Kesehatan <?php echo $data['nama_alkes']; ?>? </h6>
                                                    </div>
                                ...
                                <?php echo "<td style='font-size: clamp(12px, 1vw, 15px);'>"; ?>
                                     <!-- Button search -->
                                    <?php echo " <a href='VAlatKesehatan?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir&kode_alkes=$kode_alkes'><i class='fa-solid fa-magnifying-glass'></i></a>"; ?>
