...
$table = mysqli_query($koneksi, "SELECT * FROM ruangan");
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#601848;">
                 ...
                 <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3">
                    ...
                    <?php echo "<a href='VRuangan'><h5 class='text-center sm' style='color:white; margin-top: 8px; font-size: clamp(2px, 3vw, 22px);'>Data Ruangan</h5></a>"; ?>
...
<div class="row">
 ...
 <div class="col-md-2">
   ...
   <div align="right">
     <button  style= "font-size: clamp(7px, 3vw, 15px); " type="button" class="btn btn-primary" data-toggle="modal" data-target="#input"> <i class="fas fa-plus-square mr-2"></i>Input Ruangan</button> <br> <br>
   </div>
   <!-- Form Modal  -->
    ...
    <div class="modal-dialog modal-lg" role ="document">
      <div class="modal-content"> 
       <div class="modal-header">
         <h5 class="modal-title"> Form Input Ruangan</h5>
       ...
       <div class="modal-body" align="left">
         <?php  echo "<form action='../proses/PTambahRuangan' enctype='multipart/form-data' method='POST'>";  ?>
         ...
         <div class="row">
           <div class="col-md-6">
             ...
             <input class="form-control form-control-sm" type="text"  name="nama_ruangan" required="">
           </div>    
...
<thead>
 <tr>
   <th style="font-size: clamp(12px, 1vw, 15px);">Kode Ruangan</th>
   <th style="font-size: clamp(12px, 1vw, 15px);">Nama Ruangan</th>
   <th></th>
 </tr>
</thead>
<tbody>
...
?>
 <?php while($data = mysqli_fetch_array($table)){
  ...
  echo "<tr>
  <td style='font-size: clamp(12px, 1vw, 15px);' >$kode_ruangan</td>
  <td style='font-size: clamp(12px, 1vw, 15px);' >$nama_ruangan</td>
  "; ?>
  <?php echo "<td style='font-size: clamp(12px, 1vw, 15px);'>"; ?>
  <button style= " font-size: clamp(7px, 1vw, 10px); color:black; " href="#" type="submit" class=" btn bg-warning mr-2 rounded" data-toggle="modal" data-target="#formedit<?php echo $data['kode_ruangan']; ?>" data-toggle='tooltip' title='Edit Data Tindakan'> 
  <i class="fas fa-edit"></i> Edit</button>
  <!-- Form EDIT DATA -->

  <div class="modal fade" id="formedit<?php echo $data['kode_ruangan']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
   <div class="modal-dialog modal-lg" role ="document">
     <div class="modal-content"> 
       <div class="modal-header">
       ...
       <div class="modal-body">
         <form action="../proses/EDataRuangan" enctype="multipart/form-data" method="POST">

         <div class="row">
           <div class="col-md-6">
             <label>Kode Ruangan</label>
             <input class="form-control form-control-sm" type="text"  name="kode_ruangan" value="<?= $kode_ruangan; ?>" required="" disabled>
             <input type="hidden" name="kode_ruangan" value="<?= $kode_ruangan; ?>">
           </div>    
           <div class="col-md-6">
             <label>Nama Ruangan</label>
             <input class="form-control form-control-sm" type="text"  name="nama_ruangan"  value="<?= $nama_ruangan; ?>" required="">
           </div>    
           </div>
          <br>
         <div class="row">
 ...
 <!-- Button Hapus -->
 <button style= " font-size: clamp(7px, 1vw, 10px);color:black;" href="#" type="submit" class=" btn btn-danger" data-toggle="modal" data-target="#PopUpHapus<?php echo $data['kode_ruangan']; ?>" data-toggle='tooltip' title='Hapus Data Tindakan'>
 <i class="fa-solid fa-trash"></i> Hapus</button>
 <div class="modal fade" id="PopUpHapus<?php echo $data['kode_ruangan']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
  <div class="modal-dialog" role ="document">
    <div class="modal-content"> 
     ...
     <div class="modal-body">
       <form action="../proses/HDataRuangan" method="POST">
         <input type="hidden" name="kode_ruangan" value="<?php echo $kode_ruangan ;?>">
         <div class="form-group">
           <h6> Yakin Ingin Hapus Data <?php echo $data['nama_ruangan']; ?>? </h6>             
         </div>
